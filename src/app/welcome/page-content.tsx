...
export default function PageContent() {
  ...
  const ballARef = useRef<HTMLSpanElement | null>(null);
  const ballBRef = useRef<HTMLSpanElement | null>(null);
  ...
  return (
    <>
      ...
      <section className="flex-center relative min-h-screen w-full max-w-screen overflow-clip">
        <span className="bg-foreground/70 absolute top-1/2 left-6/10 z-1 size-125 -translate-1/2 rounded-full blur-2xl duration-200"></span>
        <span className="bg-chart-2/80 absolute top-14/20 left-83/100 z-1 size-125 -translate-1/2 rounded-full blur-2xl duration-200"></span>
